...
func TestClassify(t *testing.T) {
	...
	tests := []struct {
		...
		{"prior tested", "codex_cli_rs/0.155.1 (Mac OS; arm64)", "0.155.1", Tested, ""},
		{"in-between tested", "codex_cli_rs/0.156.0 (Linux; arm64)", "0.156.0", Tested, ""},
		{"patch tested", "codex_cli_rs/0.156.1 (Linux; arm64)", "0.156.1", Tested, ""},
		{"latest tested", "codex_cli_rs/0.157.0 (Linux; arm64)", "0.157.0", Tested, ""},
		{"latest tested build metadata", "codex_app_server/0.157.0+managed", "0.157.0+managed", Tested, ""},
		{"newer", "codex_cli_rs/0.155.0", "0.155.0", Untested, WarningUntested},
		{"future patch", "codex_cli_rs/0.157.1", "0.157.1", Untested, WarningUntested},
		{"prerelease", "codex_cli_rs/0.157.0-alpha.11", "0.157.0-alpha.11", Untested, WarningUntested},
