...
func TestResolverPinsEndpointAndUsesExplicitRuntimeStateProbe(t *testing.T) {
	...
	if !probed || got.EndpointID != testTargetEndpoint || got.EndpointAlias != "target" || got.Transport != "unix" || got.ThreadID != "thread-1" || got.Loaded || !got.Persistent || got.URI != "codex://"+testTargetEndpoint+"/thread/thread-1" {
